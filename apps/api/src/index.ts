import { createDatabase, migrate, seedDemoAccounts } from '@linkup/db'
...
function main(): void {
  ...
  // Ensure rich demo creators, profiles, and Go Open cards exist on boot
  const seededCount = seedDemoAccounts(db)
  console.log(`[seed] verified/seeded ${seededCount} demo creator accounts`)
